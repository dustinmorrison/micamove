...
products = [
  ...
  { :name => "The Plank", 
    ...
    :description => "The Plank Wooden Watch, Blonde SolidCore™ Wood, White Carbon Mesh Dial, 3 Hand Japan Movement, Black Stainless Steel Clasp, 44mm, $185 USD Buy Now",  
  	...
  	:image2 => "/assets/products/watches/maple/plank-white/plank-maple-white-profile.jpg", 
  ...
  { :name => "The Deck", 
    :collection => "Maple",
    :color => "Black", 
    :title => "The Deck Maple Black SolidCore Wood Watch | Men's Watches",
    ...
    :url => "the-deck-maple-black-wood-watch-40mm",
    :sizing => "Large Size (40.5mm)" 
  },
  ...
  { :name => "The Deck", 
    :collection => "Maple",
    :color => "Bronze", 
    :title => "The Deck Maple Bronze SolidCore Wood Watch | Men's Watches",
    :description => "The Deck Wooden Watch, Maple SolidCore™ Wood, Bronze Brushed Steel Dial, 3 Hand Japan Movement, bronze Stainless Steel Clasp, 40.5mm, $175 USD Buy Now", 
    :category => "Watches", 
    ...
    :url => "the-deck-maple-bronze-wood-watch-40mm",
    :sizing => "Large Size (40.5mm)" 
  },
  ...
  { :name => "The Drift", 
    :collection => "Maple",
    :color => "Black", 
    :title => "The Drift Maple Black SolidCore Wood Watch | Men's Watches",
  ...
  { :name => "The Drift", 
    :collection => "Maple",
    :color => "Silver", 
    :title => "The Drift Maple Silver SolidCore Wood Watch | Men's Watches",
  ...
  { :name => "The Drift", 
    :collection => "Maple",
    :color => "Brown", 
    :title => "The Drift Maple Brown SolidCore Wood Watch | Men's Watches",
    :description => "The Drift Wooden Watch, Sable SolidCore™ Wood, Gold Brushed Steel Dial, 3 Hand Japan Movement, bronze Stainless Steel Clasp, 40.5mm, $175 USD Buy Now", 
    :category => "Watches", 
  ...
  { :name => "The Baron", 
    ...
    :description => "The Baron Wooden Watch, SolidCore™, Black and Teal Dial, 3 Hand Japan Movement,  Stainless Steel Clasp, 38mm, $125 USD Buy Now", 
    :category => "Watches", 
  ...
  { :name => "The Baron",
    :collection => "Maple",
    :color => "Silver", 
    :title => "The Baron Silver SolidCore™ Wood Watch| Men's Watches",
  ...
  { :name => "The Baron", 
    ...
    :price => "145", 
    :image1 => "/assets/products/watches/maple/baron-rosegold/baron-maple-rosegold-wooden-watch-crown.jpg", 
  ...
  { :name => "The Baron", 
    ...
    :price => "145", 
    :image1 => "/assets/products/watches/maple/baron-black/baron-maple-black-wooden-watch-crown.jpg", 
